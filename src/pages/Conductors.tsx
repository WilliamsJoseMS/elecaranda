      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            { code: "RZ1MAZ1-K", breakdown: [["R", "Reticulado (XLPE)"], ["Z1", "Libre de halógenos (interior)"], ["MA", "Hilos de ALUMINIO (Armadura)"], ["Z1", "Libre de halógenos (exterior)"]], use: "Cable UNIPOLAR con armadura de aluminio para evitar corrientes inducidas. 'Doble Z1' para máxima seguridad LSZH.", color: "border-cyan-600 bg-cyan-900/20" },
            { code: "RZ1FAZ1-K", breakdown: [["R", "Reticulado (XLPE)"], ["Z1", "Libre de halógenos (asiento)"], ["FA", "Flejes de ALUMINIO (Armadura)"], ["Z1", "Libre de halógenos (cubierta)"]], use: "Armadura de flejes de aluminio (FA). Especial para cables unipolares de gran sección. Doble protección libre de halógenos.", color: "border-blue-600 bg-blue-900/20" },
          ].map((cable) => (
